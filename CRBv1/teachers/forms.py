...
class TeacherModifyForm(UserModifyModelForm):
    def __init__(self, *args, **kwargs):
        self.request = kwargs.pop("request")
        super(TeacherModifyForm, self).__init__(*args, **kwargs)
...
class ResetTeacherPasswordForm(ResetPasswordModelForm):
    def __init__(self, *args, **kwargs):
        self.request = kwargs.pop("request")
        super(ResetTeacherPasswordForm, self).__init__(*args, **kwargs)
