    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manualactive', models.BooleanField(db_column='manualactive', default=0)),
                ('manualdeactive', models.BooleanField(db_column='manualdeactive', default=0)),
                ('createdbyusername', models.ForeignKey(db_column='createdby', default='super', on_delete=django.db.models.deletion.CASCADE, related_name='CBR', to=settings.AUTH_USER_MODEL)),
