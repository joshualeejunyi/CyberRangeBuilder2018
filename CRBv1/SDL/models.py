...
class SDLPost(models.Model):
    ...
    createdby = models.ForeignKey('accounts.User', on_delete=models.DO_NOTHING, db_column='createdby', related_name="SDLcreatedby", null=True)
...
class SDLComment(models.Model):
    ...
    postid = models.ForeignKey('SDL.SDLPost', on_delete=models.DO_NOTHING, db_column='postid', null=True)

    commenter = models.ForeignKey('accounts.User', on_delete=models.DO_NOTHING, db_column='commenter', null=True)
